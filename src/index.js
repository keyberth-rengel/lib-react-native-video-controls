...
export default class VideoPlayer extends Component {
  ...
  renderBack() {
    return this.renderControl(
      <Image
        source={require('./assets/img-video-player/back.png')}
    ...
    return this.renderControl(
      this.props.pictureInPictureIcon ? (
        <Image
          ...
          source={require('./assets/img-video-player/icon-pip.png')}
        />
      ) : (
        this.props.pictureInPictureText && (
      ...
      <View style={styles.volume.container}>
        ...
        >
          <Image
            ...
            source={require('./assets/img-video-player/volume.png')}
          />
        </View>
      </View>
    );
  ...
  renderFullscreen() {
    let source =
      this.state.isFullscreen === true
        ? require('./assets/img-video-player/shrink.png')
        : require('./assets/img-video-player/expand.png');
    return this.renderControl(
      <Image source={source} />,
      this.methods.toggleFullscreen,
  ...
  renderBottomControls() {
    ...
    return (
      ...
      >
        <ImageBackground
          source={require('./assets/img-video-player/bottom-vignette.png')}
  ...
  renderPlayPause() {
    let source =
      this.state.paused === true
        ? require('./assets/img-video-player/play.png')
        : require('./assets/img-video-player/pause.png');
    return this.renderControl(
      <Image source={source} />,
      this.methods.togglePlayPause,
    ...
    if (this.state.loading) {
      return (
        <View style={styles.loader.container}>
          <Animated.Image
            source={require('./assets/img-video-player/loader-icon.png')}
            style={[
              styles.loader.icon,
              {
                transform: [
    ...
    if (this.state.error) {
      return (
        <View style={styles.error.container}>
          <Image
            source={require('./assets/img-video-player/error-icon.png')}
