...
Run `npm install --save react-native-video@5.2.0 lib-react-native-video-controls react-native-enable-pip-in-android react`

Then run `react-native link react-native-video`

If you're using RN < 39 run `npm install --save lib-react-native-video-controls`. Note this version includes `react-native-video` as a normal dependency instead of a peer-dependency.
...
import VideoPlayer from "lib-react-native-video-controls";
...
| pictureInPictureIcon | show the pip button (Icon) |
| pictureInPictureText | show the pip button (Text) |
